  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="overflow-x-auto scrollbar-none relative py-12 px-8 flex gap-8 items-center min-h-[480px] w-full cursor-grab active:cursor-grabbing select-none"
        style={{
      ...
      >
        ...
        <div className="absolute top-1/2 left-0 right-0 h-[2px] bg-slate-900/60 pointer-events-none z-0">
        ...
        {milestones.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div 
                className="absolute top-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-slate-900 bg-slate-950/95 flex items-center justify-center pointer-events-none z-20 hover:scale-110 transition-transform duration-300"
              >
              ...
              {/* Milestone Card box */}
              <motion.div
                whileHover={{ y: isEven ? -6 : 6, scale: 1.02 }}
